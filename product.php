					...
					<div class="row">
						...
						<div class="col-md-7">
							...
							<div class="p-price">
                                ...
                                <span>
                                    <?php if($p_old_price!=''): ?>
                                        <del><?php echo "MWK "; ?><?php echo number_format($p_old_price, 2); ?></del>
                                    <?php endif; ?> 
                                        <?php echo "MWK "; ?><?php echo number_format($p_current_price, 2); ?>
                                </span>
                            </div>
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            ...
                            <div class="text">
                                ...
                                <h4>
                                    <?php echo 'MWK '; ?><?php echo number_format($row['p_current_price'], 2); ?> 
                                    <?php if($row['p_old_price'] != ''): ?>
                                    <del>
                                        <?php echo 'MWK '; ?><?php echo number_format($row['p_old_price'], 2); ?>
                                    </del>
                                    <?php endif; ?>
                                </h4>
                                <div class="rating">
