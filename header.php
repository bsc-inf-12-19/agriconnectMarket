		...
		<div class="row inner">
			...
			<div class="col-md-4 search-area">
				<form class="navbar-form navbar-left" role="search" action="search-result.php" method="get">
					...
					<button type="submit" class="btn btn-danger" style="background-color:#333"><?php echo LANG_VALUE_3; ?></button>
				</form>
			</div>
		</div>
	</div>
				...
				<div class="menu-container">
					<div class="menu">
						<ul>
							...
							<li style="margin-left:50px"><a href="contact.php"><?php echo $contact_title; ?></a></li>
